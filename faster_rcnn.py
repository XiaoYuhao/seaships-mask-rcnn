...
class FasterRCNN(GeneralizedRCNN):
    ...
    def __init__(self, backbone, num_classes=None,
        ...
        if image_mean is None:                      #用Fine-tune pretrained model时，应该使用自己数据集的均值和方差
            image_mean = [0.485, 0.456, 0.406]      #默认图片均值：coco数据集图片均值
        if image_std is None:
            image_std = [0.229, 0.224, 0.225]       #默认图片方差：coco数据集图片方差
